...
export const metadata: Metadata = {
  title: "Jejum de 24 Horas: Como Fazer, Benefícios e Quem Deve Evitar | Nutry.life",
  description: "O jejum de 24h tem benefícios potentes mas exige preparo. Veja como fazer corretamente, o que esperar e quem não deve tentar.",
  keywords: "jejum intermitente 24 horas, OMAD, jejum prolongado",
  openGraph: {
    title: "Jejum de 24 Horas: Como Fazer, Benefícios e Quem Deve Evitar | Nutry.life",
    description: "O jejum de 24h tem benefícios potentes mas exige preparo. Veja como fazer corretamente, o que esperar e quem não deve tentar.",
    url: "https://nutry.life/blog/jejum-intermitente-24-horas",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>30 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Jejum de 24 Horas: Como Fazer, Benefícios e Quem Deve Evitar
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O jejum de 24h tem benefícios potentes mas exige preparo. Veja como fazer corretamente, o que esperar e quem não deve tentar.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O jejum de 24h tem benefícios potentes mas exige preparo. Veja como fazer corretamente, o que esperar e quem não deve tentar. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
