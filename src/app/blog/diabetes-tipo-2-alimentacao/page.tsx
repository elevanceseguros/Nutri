...
export const metadata: Metadata = {
  title: "Alimentação Para Diabetes Tipo 2: O Que Comer Para Controlar a Glicose | Nutry.life",
  description: "O controle da diabetes tipo 2 começa no prato. Veja quais alimentos estabilizam a glicose, quais elevar o risco e como montar refeições equilibradas.",
  keywords: "alimentacao diabetes tipo 2, dieta para diabeticos, como controlar glicose com alimentacao",
  openGraph: {
    title: "Alimentação Para Diabetes Tipo 2: O Que Comer Para Controlar a Glicose | Nutry.life",
    description: "O controle da diabetes tipo 2 começa no prato. Veja quais alimentos estabilizam a glicose, quais elevar o risco e como montar refeições equilibradas.",
    url: "https://nutry.life/blog/diabetes-tipo-2-alimentacao",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>11 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Alimentação Para Diabetes Tipo 2: O Que Comer Para Controlar a Glicose
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O controle da diabetes tipo 2 começa no prato. Veja quais alimentos estabilizam a glicose, quais elevar o risco e como montar refeições equilibradas.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O controle da diabetes tipo 2 começa no prato. Veja quais alimentos estabilizam a glicose, quais elevar o risco e como montar refeições equilibradas. Resultados sustentáveis vêm de mudanças consistentes, não de dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
