...
export const metadata: Metadata = {
  title: "Magnésio: Por Que Você Provavelmente Está com Deficiência | Nutry.life",
  description: "Câimbras, insônia, ansiedade, fadiga — muitos desses sintomas são de deficiência de magnésio. Veja os alimentos mais ricos e como atingir a recomendação diária.",
  keywords: "magnesio deficiencia, alimentos com magnesio, suplementar magnesio",
  openGraph: {
    title: "Magnésio: Por Que Você Provavelmente Está com Deficiência | Nutry.life",
    description: "Câimbras, insônia, ansiedade, fadiga — muitos desses sintomas são de deficiência de magnésio. Veja os alimentos mais ricos e como atingir a recomendação diária.",
    url: "https://nutry.life/blog/magnesio-na-alimentacao",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>31 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Magnésio: Por Que Você Provavelmente Está com Deficiência
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Câimbras, insônia, ansiedade, fadiga — muitos desses sintomas são de deficiência de magnésio. Veja os alimentos mais ricos e como atingir a recomendação diária.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Câimbras, insônia, ansiedade, fadiga — muitos desses sintomas são de deficiência de magnésio. Veja os alimentos mais ricos e como atingir a recomendação diária. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
