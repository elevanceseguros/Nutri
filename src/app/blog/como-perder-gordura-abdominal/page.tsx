...
export const metadata: Metadata = {
  title: "Como Perder Gordura Abdominal: O Que a Ciência Realmente Diz | Nutry.life",
  description: "Não existe exercício ou alimento mágico para a barriga. Mas existe ciência sólida sobre o que funciona. Veja o que realmente reduz a gordura visceral.",
  keywords: "como perder gordura abdominal, como perder barriga, dieta para barriga",
  openGraph: {
    title: "Como Perder Gordura Abdominal: O Que a Ciência Realmente Diz | Nutry.life",
    description: "Não existe exercício ou alimento mágico para a barriga. Mas existe ciência sólida sobre o que funciona. Veja o que realmente reduz a gordura visceral.",
    url: "https://nutry.life/blog/como-perder-gordura-abdominal",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>07 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Como Perder Gordura Abdominal: O Que a Ciência Realmente Diz
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Não existe exercício ou alimento mágico para a barriga. Mas existe ciência sólida sobre o que funciona. Veja o que realmente reduz a gordura visceral.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Não existe exercício ou alimento mágico para a barriga. Mas existe ciência sólida sobre o que funciona. Veja o que realmente reduz a gordura visceral. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo e trazem resultados duradouros.</p>
          </div>
          <div className={styles.qBlock}>
