...
export const metadata: Metadata = {
  title: "O Que Comer no Café da Manhã Para Emagrecer: 10 Opções Com Ciência | Nutry.life",
  description: "O café da manhã ideal para emagrecer tem proteína, fibra e gordura boa — e evita açúcar e carboidrato refinado. Veja 10 opções práticas com base científica.",
  keywords: "cafe da manha para emagrecer, o que comer de manha para perder peso, cafe da manha saudavel",
  openGraph: {
    title: "O Que Comer no Café da Manhã Para Emagrecer: 10 Opções Com Ciência | Nutry.life",
    description: "O café da manhã ideal para emagrecer tem proteína, fibra e gordura boa — e evita açúcar e carboidrato refinado. Veja 10 opções práticas com base científica.",
    url: "https://nutry.life/blog/o-que-comer-no-cafe-da-manha-para-emagrecer",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>14 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              O Que Comer no Café da Manhã Para Emagrecer: 10 Opções Com Ciência
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O café da manhã ideal para emagrecer tem proteína, fibra e gordura boa — e evita açúcar e carboidrato refinado. Veja 10 opções práticas com base científica.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O café da manhã ideal para emagrecer tem proteína, fibra e gordura boa — e evita açúcar e carboidrato refinado. Veja 10 opções práticas com base científica. Resultados sustentáveis vêm de mudanças consistentes, não de dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
