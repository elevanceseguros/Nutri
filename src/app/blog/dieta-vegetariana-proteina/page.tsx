...
export const metadata: Metadata = {
  title: "Dieta Vegetariana: Como Garantir Proteína Suficiente Sem Carne | Nutry.life",
  description: "É totalmente possível atingir a recomendação de proteína em uma dieta vegetariana. Veja as melhores fontes vegetais, combinações e quanto consumir por dia.",
  keywords: "dieta vegetariana proteina, proteina vegetal, como ser vegetariano saudavel",
  openGraph: {
    title: "Dieta Vegetariana: Como Garantir Proteína Suficiente Sem Carne | Nutry.life",
    description: "É totalmente possível atingir a recomendação de proteína em uma dieta vegetariana. Veja as melhores fontes vegetais, combinações e quanto consumir por dia.",
    url: "https://nutry.life/blog/dieta-vegetariana-proteina",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>06 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Dieta Vegetariana: Como Garantir Proteína Suficiente Sem Carne
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>É totalmente possível atingir a recomendação de proteína em uma dieta vegetariana. Veja as melhores fontes vegetais, combinações e quanto consumir por dia.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>É totalmente possível atingir a recomendação de proteína em uma dieta vegetariana. Veja as melhores fontes vegetais, combinações e quanto consumir por dia. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo e trazem resultados duradouros.</p>
          </div>
          <div className={styles.qBlock}>
