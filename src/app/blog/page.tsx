...
const posts = [
  ...
  {
    "slug": "legumes-vapor-agua-microondas-nutrientes",
    "titulo": "Legumes no Vapor, na Água ou no Micro-ondas: Como Escolher o Preparo",
    "descricao": "Entenda por que tempo, água e tipo de vegetal mudam a retenção de nutrientes e como cozinhar sem transformar a refeição em uma competição.",
  ...
  {
    "slug": "pipoca-panela-microondas-comparar-ingredientes",
    "titulo": "Pipoca de Panela ou Micro-ondas: O Que Realmente Muda no Lanche",
    "descricao": "Compare ingredientes, coberturas, tamanho da porção e praticidade sem confundir o aparelho usado com a qualidade da receita.",
  ...
  {
    "slug": "pasta-amendoim-integral-saborizada-como-escolher",
    "titulo": "Pasta de Amendoim Integral ou Saborizada: Como Comparar o Rótulo",
    "descricao": "Entenda o que observar em ingredientes, açúcar, porção, preço e conservação ao escolher pasta de amendoim.",
  ...
  {
    "slug": "grao-de-bico-seco-vs-conserva-como-usar",
    "titulo": "Grão-de-Bico Seco ou em Conserva: Custo, Preparo e Como Usar",
    "descricao": "Veja como comparar grão-de-bico seco e pronto, calcular o custo pelo peso drenado e aproveitar cada versão em refeições práticas.",
  ...
  {
    "slug": "leite-uht-vs-pasteurizado-conservacao-comparar",
    "titulo": "Leite UHT ou Pasteurizado: O Que Muda na Compra e na Conservação",
    "descricao": "Compare leite de caixinha e pasteurizado pelo tratamento, refrigeração, composição e tamanho da embalagem, sem confundir com teor de gordura.",
  ...
  },
  {
    ...
    "tempo": "11 min de leitura",
    "tag": "Alimentação infantil",
    "emoji": "🍎"
  },
  {
  ...
  {
    "slug": "quantas-gramas-de-proteina-por-dia",
    "titulo": "Quantas Gramas de Proteína Por Dia? Guia por Peso e Objetivo",
    "descricao": "Entenda como peso, rotina e objetivo entram na avaliação das necessidades de proteína e quando buscar orientação individual.",
