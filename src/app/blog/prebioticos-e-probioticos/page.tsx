...
export const metadata: Metadata = {
  title: "Prebióticos e Probióticos: Diferença, Benefícios e Onde Encontrar | Nutry.life",
  description: "Seu intestino contém mais neurônios que sua medula espinhal. Entenda como prebióticos e probióticos cuidam do seu microbioma.",
  keywords: "prebioticos probioticos, microbioma, saude intestinal",
  openGraph: {
    title: "Prebióticos e Probióticos: Diferença, Benefícios e Onde Encontrar | Nutry.life",
    description: "Seu intestino contém mais neurônios que sua medula espinhal. Entenda como prebióticos e probióticos cuidam do seu microbioma.",
    url: "https://nutry.life/blog/prebioticos-e-probioticos",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>23 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Prebióticos e Probióticos: Diferença, Benefícios e Onde Encontrar
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Seu intestino contém mais neurônios que sua medula espinhal. Entenda como prebióticos e probióticos cuidam do seu microbioma.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Seu intestino contém mais neurônios que sua medula espinhal. Entenda como prebióticos e probióticos cuidam do seu microbioma. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
