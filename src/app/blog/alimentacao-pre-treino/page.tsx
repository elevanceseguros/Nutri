...
export const metadata: Metadata = {
  title: "Alimentação Pré-Treino: O Que Comer Para Ter Mais Energia e Desempenho | Nutry.life",
  description: "O que você come antes do treino define sua energia, foco e recuperação. Veja o timing ideal, os melhores alimentos e o que evitar antes de se exercitar.",
  keywords: "alimentacao pre treino, o que comer antes de treinar, carboidrato pre treino",
  openGraph: {
    title: "Alimentação Pré-Treino: O Que Comer Para Ter Mais Energia e Desempenho | Nutry.life",
    description: "O que você come antes do treino define sua energia, foco e recuperação. Veja o timing ideal, os melhores alimentos e o que evitar antes de se exercitar.",
    url: "https://nutry.life/blog/alimentacao-pre-treino",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              <span className={styles.tag}>Esporte e Nutrição</span>
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>05 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Alimentação Pré-Treino: O Que Comer Para Ter Mais Energia e Desempenho
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O que você come antes do treino define sua energia, foco e recuperação. Veja o timing ideal, os melhores alimentos e o que evitar antes de se exercitar.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O que você come antes do treino define sua energia, foco e recuperação. Veja o timing ideal, os melhores alimentos e o que evitar antes de se exercitar. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo e trazem resultados duradouros.</p>
          </div>
          <div className={styles.qBlock}>
