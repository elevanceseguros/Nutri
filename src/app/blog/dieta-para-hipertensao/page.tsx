...
export const metadata: Metadata = {
  title: "Dieta para Hipertensão: O Que Comer e O Que Evitar | Nutry.life",
  description: "Pressão alta afeta 36% dos brasileiros. Veja a dieta DASH, alimentos que reduzem a pressão naturalmente e os que devem ser evitados.",
  keywords: "dieta para hipertensao, pressao alta alimentacao, dieta DASH",
  openGraph: {
    title: "Dieta para Hipertensão: O Que Comer e O Que Evitar | Nutry.life",
    description: "Pressão alta afeta 36% dos brasileiros. Veja a dieta DASH, alimentos que reduzem a pressão naturalmente e os que devem ser evitados.",
    url: "https://nutry.life/blog/dieta-para-hipertensao",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>24 de maio de 2026</span>
            ...
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Pressão alta afeta 36% dos brasileiros. Veja a dieta DASH, alimentos que reduzem a pressão naturalmente e os que devem ser evitados.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Pressão alta afeta 36% dos brasileiros. Veja a dieta DASH, alimentos que reduzem a pressão naturalmente e os que devem ser evitados. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
