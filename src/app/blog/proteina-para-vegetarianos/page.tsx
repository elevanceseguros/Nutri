...
export const metadata: Metadata = {
  title: "Proteína Para Vegetarianos: As Melhores Fontes e Como Combinar | Nutry.life",
  description: "Feijão, lentilha, grão-de-bico, tofu, quinoa: conheça as melhores fontes de proteína vegetal e como combiná-las para obter todos os aminoácidos essenciais.",
  keywords: "proteina para vegetarianos, fontes de proteina vegetal, proteina completa vegetariana",
  openGraph: {
    title: "Proteína Para Vegetarianos: As Melhores Fontes e Como Combinar | Nutry.life",
    description: "Feijão, lentilha, grão-de-bico, tofu, quinoa: conheça as melhores fontes de proteína vegetal e como combiná-las para obter todos os aminoácidos essenciais.",
    url: "https://nutry.life/blog/proteina-para-vegetarianos",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>10 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Proteína Para Vegetarianos: As Melhores Fontes e Como Combinar
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Feijão, lentilha, grão-de-bico, tofu, quinoa: conheça as melhores fontes de proteína vegetal e como combiná-las para obter todos os aminoácidos essenciais.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Feijão, lentilha, grão-de-bico, tofu, quinoa: conheça as melhores fontes de proteína vegetal e como combiná-las para obter todos os aminoácidos essenciais. Resultados sustentáveis vêm de mudanças consistentes, não de dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
