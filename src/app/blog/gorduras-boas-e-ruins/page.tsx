...
export const metadata: Metadata = {
  title: "Gorduras Boas e Ruins: Qual a Diferença e Quais Comer | Nutry.life",
  description: "Nem toda gordura engorda. Aprenda a diferença entre gorduras boas (insaturadas) e ruins (trans e saturadas) e quais incluir na sua dieta.",
  keywords: "gorduras boas e ruins, gordura insaturada, gordura trans",
  openGraph: {
    title: "Gorduras Boas e Ruins: Qual a Diferença e Quais Comer | Nutry.life",
    description: "Nem toda gordura engorda. Aprenda a diferença entre gorduras boas (insaturadas) e ruins (trans e saturadas) e quais incluir na sua dieta.",
    url: "https://nutry.life/blog/gorduras-boas-e-ruins",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>21 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Gorduras Boas e Ruins: Qual a Diferença e Quais Comer
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Nem toda gordura engorda. Aprenda a diferença entre gorduras boas (insaturadas) e ruins (trans e saturadas) e quais incluir na sua dieta.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Nem toda gordura engorda. Aprenda a diferença entre gorduras boas (insaturadas) e ruins (trans e saturadas) e quais incluir na sua dieta. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
