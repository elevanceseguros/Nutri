...
export const metadata: Metadata = {
  title: "Alimentação Anti-Envelhecimento: Os Nutrientes Que Protegem Suas Células | Nutry.life",
  description: "Envelhecer bem começa no prato. Conheça os nutrientes com maior evidência científica para proteger células, reduzir inflamação e preservar a cognição.",
  keywords: "alimentacao anti envelhecimento, antioxidantes, nutrientes longevidade",
  openGraph: {
    title: "Alimentação Anti-Envelhecimento: Os Nutrientes Que Protegem Suas Células | Nutry.life",
    description: "Envelhecer bem começa no prato. Conheça os nutrientes com maior evidência científica para proteger células, reduzir inflamação e preservar a cognição.",
    url: "https://nutry.life/blog/alimentacao-anti-envelhecimento",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              <span className={styles.tag}>Longevidade</span>
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>08 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Alimentação Anti-Envelhecimento: Os Nutrientes Que Protegem Suas Células
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Envelhecer bem começa no prato. Conheça os nutrientes com maior evidência científica para proteger células, reduzir inflamação e preservar a cognição.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Envelhecer bem começa no prato. Conheça os nutrientes com maior evidência científica para proteger células, reduzir inflamação e preservar a cognição. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo e trazem resultados duradouros.</p>
          </div>
          <div className={styles.qBlock}>
