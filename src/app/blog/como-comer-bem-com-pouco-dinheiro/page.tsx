...
export const metadata: Metadata = {
  title: "Como Comer Bem Com Pouco Dinheiro: Alimentação Saudável no Orçamento | Nutry.life",
  description: "Comer bem não precisa ser caro. Com planejamento e escolhas inteligentes, é possível montar uma alimentação saudável e nutritiva gastando pouco.",
  keywords: "como comer saudavel com pouco dinheiro, alimentacao barata e saudavel, orcamento alimentar",
  openGraph: {
    title: "Como Comer Bem Com Pouco Dinheiro: Alimentação Saudável no Orçamento | Nutry.life",
    description: "Comer bem não precisa ser caro. Com planejamento e escolhas inteligentes, é possível montar uma alimentação saudável e nutritiva gastando pouco.",
    url: "https://nutry.life/blog/como-comer-bem-com-pouco-dinheiro",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              <span className={styles.tag}>Economia</span>
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>09 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Como Comer Bem Com Pouco Dinheiro: Alimentação Saudável no Orçamento
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Comer bem não precisa ser caro. Com planejamento e escolhas inteligentes, é possível montar uma alimentação saudável e nutritiva gastando pouco.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Comer bem não precisa ser caro. Com planejamento e escolhas inteligentes, é possível montar uma alimentação saudável e nutritiva gastando pouco. Resultados sustentáveis vêm de mudanças consistentes, não de dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
