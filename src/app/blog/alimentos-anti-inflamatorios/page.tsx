...
export const metadata: Metadata = {
  title: "Alimentos Anti-inflamatórios: Lista Completa e Como Usar | Nutry.life",
  description: "A inflamação crônica está por trás de diabetes, doenças cardíacas e obesidade. Veja a lista completa de alimentos que combatem a inflamação.",
  keywords: "alimentos anti inflamatorios, inflamacao cronica, dieta anti inflamatoria",
  openGraph: {
    title: "Alimentos Anti-inflamatórios: Lista Completa e Como Usar | Nutry.life",
    description: "A inflamação crônica está por trás de diabetes, doenças cardíacas e obesidade. Veja a lista completa de alimentos que combatem a inflamação.",
    url: "https://nutry.life/blog/alimentos-anti-inflamatorios",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>29 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Alimentos Anti-inflamatórios: Lista Completa e Como Usar
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>A inflamação crônica está por trás de diabetes, doenças cardíacas e obesidade. Veja a lista completa de alimentos que combatem a inflamação.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>A inflamação crônica está por trás de diabetes, doenças cardíacas e obesidade. Veja a lista completa de alimentos que combatem a inflamação. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
