...
export const metadata: Metadata = {
  title: "Como Reduzir o Açúcar da Dieta Sem Sofrimento | Nutry.life",
  description: "O açúcar adicionado está em tudo. Veja como identificá-lo nos rótulos, substituições práticas e como reduzir sem abrir mão do sabor.",
  keywords: "como reduzir acucar, acucar na dieta, substituir acucar",
  openGraph: {
    title: "Como Reduzir o Açúcar da Dieta Sem Sofrimento | Nutry.life",
    description: "O açúcar adicionado está em tudo. Veja como identificá-lo nos rótulos, substituições práticas e como reduzir sem abrir mão do sabor.",
    url: "https://nutry.life/blog/como-reduzir-o-acucar-da-dieta",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>22 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Como Reduzir o Açúcar da Dieta Sem Sofrimento
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O açúcar adicionado está em tudo. Veja como identificá-lo nos rótulos, substituições práticas e como reduzir sem abrir mão do sabor.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O açúcar adicionado está em tudo. Veja como identificá-lo nos rótulos, substituições práticas e como reduzir sem abrir mão do sabor. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
