...
export const metadata: Metadata = {
  title: "Como Montar um Prato Equilibrado Pelo Método do Prato | Nutry.life",
  description: "O método do prato divide a refeição em proporções simples sem precisar contar calorias. Aprenda a montar refeições balanceadas de forma visual.",
  keywords: "como montar prato equilibrado, metodo do prato, porcoes alimentares",
  openGraph: {
    title: "Como Montar um Prato Equilibrado Pelo Método do Prato | Nutry.life",
    description: "O método do prato divide a refeição em proporções simples sem precisar contar calorias. Aprenda a montar refeições balanceadas de forma visual.",
    url: "https://nutry.life/blog/como-montar-prato-equilibrado",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>28 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Como Montar um Prato Equilibrado Pelo Método do Prato
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>O método do prato divide a refeição em proporções simples sem precisar contar calorias. Aprenda a montar refeições balanceadas de forma visual.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>O método do prato divide a refeição em proporções simples sem precisar contar calorias. Aprenda a montar refeições balanceadas de forma visual. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
