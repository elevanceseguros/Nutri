...
export const metadata: Metadata = {
  title: "Colágeno na Alimentação: O Que Realmente Funciona Para a Pele | Nutry.life",
  description: "Suplementar colágeno ou comer os alimentos certos? Veja o que a ciência diz sobre colágeno na dieta e como estimular a produção natural.",
  keywords: "colageno alimentacao, colageno pele, alimentos com colageno",
  openGraph: {
    title: "Colágeno na Alimentação: O Que Realmente Funciona Para a Pele | Nutry.life",
    description: "Suplementar colágeno ou comer os alimentos certos? Veja o que a ciência diz sobre colágeno na dieta e como estimular a produção natural.",
    url: "https://nutry.life/blog/colageno-na-alimentacao",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>25 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Colágeno na Alimentação: O Que Realmente Funciona Para a Pele
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Suplementar colágeno ou comer os alimentos certos? Veja o que a ciência diz sobre colágeno na dieta e como estimular a produção natural.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Suplementar colágeno ou comer os alimentos certos? Veja o que a ciência diz sobre colágeno na dieta e como estimular a produção natural. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
