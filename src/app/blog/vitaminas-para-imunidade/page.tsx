...
export const metadata: Metadata = {
  title: "Vitaminas Para Imunidade: O Que Realmente Funciona e O Que É Mito | Nutry.life",
  description: "Vitamina C, D, zinco, selênio: quais realmente fortalecem o sistema imunológico e em que doses? Separe mito de ciência e entenda o que a alimentação pode fazer pela sua imunidade.",
  keywords: "vitaminas para imunidade, vitamina c imunidade, como fortalecer sistema imune",
  openGraph: {
    title: "Vitaminas Para Imunidade: O Que Realmente Funciona e O Que É Mito | Nutry.life",
    description: "Vitamina C, D, zinco, selênio: quais realmente fortalecem o sistema imunológico e em que doses? Separe mito de ciência e entenda o que a alimentação pode fazer pela sua imunidade.",
    url: "https://nutry.life/blog/vitaminas-para-imunidade",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>15 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Vitaminas Para Imunidade: O Que Realmente Funciona e O Que É Mito
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Vitamina C, D, zinco, selênio: quais realmente fortalecem o sistema imunológico e em que doses? Separe mito de ciência e entenda o que a alimentação pode fazer pela sua imunidade.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Vitamina C, D, zinco, selênio: quais realmente fortalecem o sistema imunológico e em que doses? Separe mito de ciência e entenda o que a alimentação pode fazer pela sua imunidade. Resultados sustentáveis vêm de mudanças consistentes, não de dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
