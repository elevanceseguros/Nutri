...
export const metadata: Metadata = {
  title: "Planejamento Alimentar Semanal: Como Planejar Refeições e Poupar Tempo | Nutry.life",
  description: "Planejar as refeições da semana economiza tempo, reduz desperdício e facilita manter uma alimentação saudável mesmo com rotina agitada.",
  keywords: "planejamento alimentar semanal, meal prep, preparar refeicoes semana",
  openGraph: {
    title: "Planejamento Alimentar Semanal: Como Planejar Refeições e Poupar Tempo | Nutry.life",
    description: "Planejar as refeições da semana economiza tempo, reduz desperdício e facilita manter uma alimentação saudável mesmo com rotina agitada.",
    url: "https://nutry.life/blog/planejamento-alimentar-semanal",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>02 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Planejamento Alimentar Semanal: Como Planejar Refeições e Poupar Tempo
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Planejar as refeições da semana economiza tempo, reduz desperdício e facilita manter uma alimentação saudável mesmo com rotina agitada.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Planejar as refeições da semana economiza tempo, reduz desperdício e facilita manter uma alimentação saudável mesmo com rotina agitada. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
