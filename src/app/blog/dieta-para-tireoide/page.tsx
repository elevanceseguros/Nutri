...
export const metadata: Metadata = {
  title: "Dieta Para Tireoide: O Que Comer e Evitar no Hipotireoidismo e Hipertireoidismo | Nutry.life",
  description: "A tireoide regula o metabolismo inteiro. Entenda quais alimentos apoiam a função tireoidiana e quais interferem na absorção do hormônio sintético.",
  keywords: "dieta para tireoide, hipotireoidismo alimentacao, hipertireoidismo o que comer",
  openGraph: {
    title: "Dieta Para Tireoide: O Que Comer e Evitar no Hipotireoidismo e Hipertireoidismo | Nutry.life",
    description: "A tireoide regula o metabolismo inteiro. Entenda quais alimentos apoiam a função tireoidiana e quais interferem na absorção do hormônio sintético.",
    url: "https://nutry.life/blog/dieta-para-tireoide",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>03 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Dieta Para Tireoide: O Que Comer e Evitar no Hipotireoidismo e Hipertireoidismo
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>A tireoide regula o metabolismo inteiro. Entenda quais alimentos apoiam a função tireoidiana e quais interferem na absorção do hormônio sintético.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>A tireoide regula o metabolismo inteiro. Entenda quais alimentos apoiam a função tireoidiana e quais interferem na absorção do hormônio sintético. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo e trazem resultados duradouros.</p>
          </div>
          <div className={styles.qBlock}>
