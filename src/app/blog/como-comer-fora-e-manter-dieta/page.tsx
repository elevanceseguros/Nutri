...
export const metadata: Metadata = {
  title: "Como Comer Fora de Casa e Manter a Dieta | Nutry.life",
  description: "Restaurante, lanchonete, happy hour: manter a dieta fora de casa parece difícil mas tem estratégias simples e eficazes.",
  keywords: "como comer fora dieta, alimentacao saudavel restaurante, manter dieta",
  openGraph: {
    title: "Como Comer Fora de Casa e Manter a Dieta | Nutry.life",
    description: "Restaurante, lanchonete, happy hour: manter a dieta fora de casa parece difícil mas tem estratégias simples e eficazes.",
    url: "https://nutry.life/blog/como-comer-fora-e-manter-dieta",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>26 de maio de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Como Comer Fora de Casa e Manter a Dieta
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Restaurante, lanchonete, happy hour: manter a dieta fora de casa parece difícil mas tem estratégias simples e eficazes.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Restaurante, lanchonete, happy hour: manter a dieta fora de casa parece difícil mas tem estratégias simples e eficazes. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
