...
export const metadata: Metadata = {
  title: "Carboidratos Bons e Ruins: Guia Para Não Ter Medo de Carbs | Nutry.life",
  description: "Cortar todo carboidrato é erro. Aprenda a diferença entre carboidratos simples e complexos, índice glicêmico e como incluir carbs de forma inteligente.",
  keywords: "carboidratos bons ruins, indice glicemico, carboidrato simples complexo",
  openGraph: {
    title: "Carboidratos Bons e Ruins: Guia Para Não Ter Medo de Carbs | Nutry.life",
    description: "Cortar todo carboidrato é erro. Aprenda a diferença entre carboidratos simples e complexos, índice glicêmico e como incluir carbs de forma inteligente.",
    url: "https://nutry.life/blog/carboidratos-bons-e-ruins",
  },
};
        ...
        <div className="fade-up">
          ...
          <div style={{ marginBottom: "2.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: "0.82rem", color: "#9ca3af", fontWeight: 600 }}>01 de junho de 2026</span>
            ...
            <h1 className={styles.heroTitle} style={{ fontSize: "clamp(1.8rem, 5vw, 2.8rem)", marginBottom: "1rem" }}>
              Carboidratos Bons e Ruins: Guia Para Não Ter Medo de Carbs
            </h1>
            <p className={styles.heroSub} style={{ marginBottom: "0" }}>Cortar todo carboidrato é erro. Aprenda a diferença entre carboidratos simples e complexos, índice glicêmico e como incluir carbs de forma inteligente.</p>
          </div>
          ...
          <div className={styles.qBlock}>
            ...
            <p style={{ color: "#374151", lineHeight: 1.8, fontSize: "0.95rem" }}>Cortar todo carboidrato é erro. Aprenda a diferença entre carboidratos simples e complexos, índice glicêmico e como incluir carbs de forma inteligente. A alimentação equilibrada é a base de qualquer resultado sustentável. Pequenas mudanças consistentes superam dietas radicais de curto prazo.</p>
          </div>
          <div className={styles.qBlock}>
