      ...
      <main className={styles.main}>
        ...
        {screen === "onboarding" && (
          <div className="fade-up">
            ...
            <p className={styles.heroSub}>
              A gente monta o plano perfeito — com receitas reais, balanceadas e fáceis.
            </p>

            <div className={styles.qBlock}>
              <div className={styles.qLabel}>01 — Qual é o seu objetivo?</div>
            ...
            <div className={styles.qBlock}>
              <div className={styles.qLabel}>02 — Preferência alimentar</div>
              <div className={styles.qGrid}>
                {([
            ...
            <div className={styles.qBlock}>
              <div className={styles.qLabel}>03 — Quantas refeições hoje?</div>
        ...
        {screen === "loading" && (
          <div className={styles.loadWrap}>
            ...
            <div className={styles.loadSub}>Calculando macros e escolhendo receitas brasileiras</div>
          </div>
        )}
              ...
              <div key={i} className={styles.mealCard}>
                ...
                {openMeal === i && (
                  <div className={styles.mealBody}>
                    ...
                    <div className={styles.ingLabel}>Ingredientes</div>
                    <ul className={styles.ingList}>
                      {r.ingredientes.map((ing,j) => (
                        <li key={j} className={styles.ingItem}><span className={styles.dot}/>{ing}</li>
                      ))}
                    </ul>
